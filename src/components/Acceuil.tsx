...
const Acceuil = () => {
  return (
    <section className={css({ padding: '2rem 0', width: '100%',})}>
      ...
      <h2 className={css({ fontSize: { base: '50px', lg:'70px'}, fontWeight: 'bold', lineHeight: '0.9', width: '75%', marginBottom: '1rem', fontFamily: 'saira', textAlign: 'center', '@media (min-width: 1024px)': { fontSize: '80px' }, '@media (min-width: 1280px)': { fontSize: '100px' }})}>
  Plusieurs services <span style={{ color: colors.primary }}>fusionné</span> en un hébergeur! 
</h2>
